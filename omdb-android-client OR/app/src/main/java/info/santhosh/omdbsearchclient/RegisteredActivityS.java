...
public class RegisteredActivityS extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (!(adpFilmes == null)) {
                ...
                lista_vazia.setMessage("Você ainda não registrou nenhum filme como 'assistido'");
